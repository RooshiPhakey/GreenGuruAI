...
export default function Chat() {
  const [messages, setMessages] = useState([
    { role: 'assistant', content: 'Hey! Whats Good!? Im Blaze. Ask me about cannabis education, legality by country, safer use, product types, or industry trends. I keep it anonymous ✌️' }
  ])
